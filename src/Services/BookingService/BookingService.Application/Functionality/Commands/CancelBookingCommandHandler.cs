...
public class CancelBookingCommandHandler : IRequestHandler<UserCancelBookingCommand, CancelBookingResponseDto>
{
    ...
    public async Task<CancelBookingResponseDto> Handle(UserCancelBookingCommand request, CancellationToken cancellationToken)
    {
