...
public class GetBookingsQueryHandler : IRequestHandler<GetBookingsQuery, PagedBookingsResponse>
{
    ...
    public async Task<PagedBookingsResponse> Handle(GetBookingsQuery request, CancellationToken cancellationToken)
    {
