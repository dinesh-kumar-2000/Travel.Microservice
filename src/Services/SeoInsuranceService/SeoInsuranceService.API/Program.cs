using SeoInsuranceService.Application;
using SeoInsuranceService.Infrastructure;
...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("Service", "SeoInsuranceService")
...
{
    c.SwaggerDoc("v1", new() { Title = "SEO Insurance Service API", Version = "v1" });
});
